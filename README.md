...
Spawns one fresh Autotsar Army Bus at `13705,1793,0` once per save. The bus has a curated clean inventory, no fuel, and a 100%-condition battery at 0% charge.

Dependencies: Autotsar Tuning Atelier Bus, More Traits, Scavenging Skill, and Extra Books.
