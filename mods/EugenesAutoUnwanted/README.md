...
- It uses Organized Categories' runtime display categories; ammunition and unrelated item groups are ignored.
- All six item-group checkboxes default to on.

Dependency: Organized Categories: Core (`organizedCategories_core`).

Restart the game after installing, then configure the mod on the **Eugene's Auto Unwanted** page in World Settings.
